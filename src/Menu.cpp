...
Menu::Menu ()
{
	...
	gui.add (color.setup ("Color", ofColor (100, 100, 140, 20), ofColor (0, 0), ofColor (255, 255)));
	gui.add (lightPos.setup ("Light Position", ofVec3f (ofGetWidth () * 0.5, ofGetHeight () * 0.5, 100),
